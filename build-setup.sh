...
$NITROGEN && rm -rf vendor/nitrogen
...
$SYBERIA && git clone https://github.com/TRINK8T/android_build.git -b 11.0 build/make
...
$SYBERIA && git clone https://github.com/TRINK8T/system_sepolicy.git -b 11.0 system/sepolicy
...
$NITROGEN && git clone https://github.com/TRINK8T/vendor_nitrogen.git -b 11.0 vendor/nitrogen
